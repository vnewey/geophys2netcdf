...
# 2D' # This is not valid
        ...
        self.YX_order = self.data_variable.dimensions[
            1] in NetCDF2DUtils.HORIZONTAL_VARIABLE_NAMES
    ...
    def get_utm_crs(self, coordinate, from_crs=None):
        ...
        latlon_coord_trans = self.get_coordinate_transformation(
            from_crs, 'EPSG:4326')
    ...
    def transform_coords(self, coordinates, from_crs=None, to_crs=None):
        ...
        coord_trans = self.get_coordinate_transformation(
    ...
    def get_value_at_coords(self, coordinates, crs=None,
        ...
        '''
        # Use arbitrary maximum request size of NetCDF2DUtils.DEFAULT_MAX_BYTES
    ...
    def get_interpolated_value_at_coords(
        ...
        NetCDF2DUtils.DEFAULT_MAX_BYTES
